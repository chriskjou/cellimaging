...
def everything(imagefolder, csvfolder):
    is_training = False
    image_class = 0
    ...
    for i in files:
        ...
        cellcoords = H.screenshot(imgname)
        infectedperdropdict[i] = H.updateDict(filesdict[i], cellcoords, sizedict[i][0][0], sizedict[i][0][1])
